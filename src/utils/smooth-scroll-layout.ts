...
export function getLayoutScrollHeight(animationItems: PhotoAnimation[]): number {
  if (animationItems.length === 0) {
    return MIN_LAYOUT_SCROLL_HEIGHT;
  }
  const totalScrollSpan = animationItems.reduce((sum, a) => sum + a.scrollSpan, 0);
...
const ANIMATION_SCHEDULE = [
  { startRatio: 0.08, scrollSpan: 1080, entryPortion: 0.34, holdPortion: 0.16, exitPortion: 0.5 },
  { startRatio: 0.15, scrollSpan: 1540, entryPortion: 0.32, holdPortion: 0.32, exitPortion: 0.36 },
  { startRatio: 0.23, scrollSpan: 1500, entryPortion: 0.31, holdPortion: 0.34, exitPortion: 0.35 },
  { startRatio: 0.3, scrollSpan: 1620, entryPortion: 0.3, holdPortion: 0.35, exitPortion: 0.35 },
  { startRatio: 0.38, scrollSpan: 1680, entryPortion: 0.29, holdPortion: 0.37, exitPortion: 0.34 },
  { startRatio: 0.46, scrollSpan: 1620, entryPortion: 0.29, holdPortion: 0.37, exitPortion: 0.34 },
  { startRatio: 0.55, scrollSpan: 1760, entryPortion: 0.27, holdPortion: 0.4, exitPortion: 0.33 },
  { startRatio: 0.63, scrollSpan: 1960, entryPortion: 0.26, holdPortion: 0.42, exitPortion: 0.32 },
];
